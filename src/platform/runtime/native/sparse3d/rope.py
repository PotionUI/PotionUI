# Derived from: microsoft/TRELLIS.2 (MIT) — trellis2/modules/sparse/attention/rope.py
"""3D rotary position embedding keyed on sparse voxel coords."""
...
__all__ = ["SparseRotaryPositionEmbedder"]
...
class SparseRotaryPositionEmbedder(nn.Module):
    ...
    def forward(self, q: SparseTensor, k: Optional[SparseTensor] = None):
        """
        Args:
            q (SparseTensor): [N, H, D] sparse tensor of queries.
            k (SparseTensor): [N, H, D] sparse tensor of keys.
        """
