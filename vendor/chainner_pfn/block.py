#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Vendored from chaiNNer — https://github.com/chaiNNer-org/chaiNNer
# Upstream path: backend/src/nodes/impl/pytorch/architecture/block.py @ e4cee69e1fb8a38c1a5cdb7a4b5089cfa15a3179
# ESRGAN RRDB super-resolution architecture. License: GPL-3.0 (see LICENSE in this directory).
# Copyright (c) chaiNNer contributors. Local modifications: none apparent.
