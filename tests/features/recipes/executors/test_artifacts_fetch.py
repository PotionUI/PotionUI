...
from src.features.recipes.schema import Recipe, RecipeArtifact, RecipeChecksum, RecipeStep
...
def test_reports_bytes_progress_per_poll_tick(monkeypatch):
    ...
    from src.features.recipes.executors import artifacts_fetch as artifacts_fetch_module
