...
// marketplace/civitai-provider/frontend/src/ExportCivitaiButton.svelte
...
function ExportCivitaiButton($$anchor, $$props) {
  if (new.target)
    return createClassComponent({ component: ExportCivitaiButton, ...$$anchor });
  push($$props, false);
  ...
  async function handleExport() {
    if (get(exporting) || !context().generationId)
      return;
    set(exporting, true);
    try {
