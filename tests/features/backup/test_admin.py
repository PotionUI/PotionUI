...
READ_ONLY_DIRS_UNENFORCED = os.name == "nt" or getattr(os, "geteuid", lambda: -1)() == 0
...
class TestOverview:
    ...
    @pytest.mark.skipif(READ_ONLY_DIRS_UNENFORCED, reason="read-only directory bits are not enforced for root or on Windows")
