...
// content/plugins/marketplace/example-extensions/frontend/src/ExampleAdminTab.svelte
var root = from_html(`<div class="example-admin-tab svelte-1dmuwst"><h2 class="svelte-1dmuwst">Example Extension</h2> <p>This tab is contributed by the <code>example-extensions</code> plugin via the <code>admin.tabs</code> extension slot.</p></div>`);
var $$css = {
  hash: "svelte-1dmuwst",
  code: ".example-admin-tab.svelte-1dmuwst {padding:1.5rem;}h2.svelte-1dmuwst {font-size:1.125rem;font-weight:600;margin-bottom:0.5rem;}"
};
function ExampleAdminTab($$anchor, $$props) {
  if (new.target) return createClassComponent({ component: ExampleAdminTab, ...$$anchor });
  push($$props, false);
...
export {
  ExampleAdminTab as default
};
//# sourceMappingURL=ExampleAdminTab.js.map
