...
# Source file: models/modules/aspp.py at commit
# 25cb9309bacf3dde954e4584594e16e142c51de5.
# License: MIT (see LICENSE in this directory). Copyright (c) 2024 ZhengPeng.
# Local modifications: only the deformable variant is kept. `dec_att` is pinned
# to 'ASPPDeformable' in config.py, so the dilated `ASPP`/`_ASPPModule` pair is
# unreachable and its parameters are absent from these checkpoints.
