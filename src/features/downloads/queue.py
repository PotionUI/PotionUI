...
class DownloadQueue:
    ...
    def __init__(
        ...
        # Two distinct settings objects: `app_settings` is the injected
        # platform settings store (get_setting), `settings` is this feature's
    ...
    def _resolve_contained_dir(
        ...
        return DownloadQueue._verify_contained_dir(root, candidate, label=subdir)
