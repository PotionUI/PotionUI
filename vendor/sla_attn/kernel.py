...
# Source file: ComfyUI-H3-SLA-Attention/sla/kernel.py at commit
# 6ca3037bd16dc143b6d461c67c87a28ca8074063 (2026-08-20).
# License: MIT (see LICENSE in this directory) over Apache-2.0 -- PlagueKind's
# own header below names the further upstream hop, LightX2V.
# Local modifications: none. The launch-config ladder and its measurements are
# PlagueKind's own (not upstream LightX2V's, which hardcodes one config that
# does not fit sm_120's shared memory) and are kept unchanged. Comments below
# are upstream's (PlagueKind's) own.
