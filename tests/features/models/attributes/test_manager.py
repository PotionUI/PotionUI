"""`ModelAttributeDefinitionsManager`: definition CRUD + system guards, plugin
...
class ModelAttributeDefinitionsManagerTestBase(PersistenceTestBase):
    ...
    def setUp(self):
        ...
        self.manager = ModelAttributeDefinitionsManager(self.definitions, self.user_attributes)


class TestDefinitionCrud(ModelAttributeDefinitionsManagerTestBase):
...
class TestSystemDefinitionGuards(ModelAttributeDefinitionsManagerTestBase):
...
class TestPluginManifestWiring(ModelAttributeDefinitionsManagerTestBase):
...
class TestUpdateUserValues(ModelAttributeDefinitionsManagerTestBase):
