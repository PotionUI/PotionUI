...
# Source file: sol_attn/triton_ref/fwd.py at commit
# a8a9584e1ed700f2ce3b7569048cab0071bbf58a.
# License: Apache-2.0 (see ../LICENSE).
# Local modifications: the two `from sol_attn.<mod> import ...` absolute
# imports are relative here, because the package is `vendor.sol_attn`, not a
# top-level `sol_attn` on sys.path. Nothing else changed.
...
from ..interface import _validate
