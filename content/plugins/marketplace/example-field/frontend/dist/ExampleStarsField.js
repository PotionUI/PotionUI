...
// local/example-field/frontend/src/ExampleStarsField.svelte
var root = from_html(`<label class="example-stars-label svelte-1feughz"> </label>`);
var root_1 = from_html(`<button type="button" role="radio">&#9733;</button>`);
var root_2 = from_html(`<p class="example-stars-desc svelte-1feughz"> </p>`);
var root_3 = from_html(`<div class="example-stars-field svelte-1feughz"><!> <div class="example-stars-row svelte-1feughz" role="radiogroup"></div> <!></div>`);
var $$css = {
  hash: "svelte-1feughz",
  code: ".example-stars-field.svelte-1feughz {padding:0.5rem 0;}.example-stars-label.svelte-1feughz {display:block;font-size:0.75rem;font-weight:500;margin-bottom:0.375rem;opacity:0.8;}.example-stars-row.svelte-1feughz {display:flex;gap:0.25rem;}.example-star.svelte-1feughz {background:none;border:none;font-size:1.5rem;line-height:1;cursor:pointer;opacity:0.3;padding:0;transition:opacity 0.15s ease, transform 0.1s ease;}.example-star.svelte-1feughz:hover {transform:scale(1.15);}.example-star.filled.svelte-1feughz {opacity:1;}.example-stars-desc.svelte-1feughz {font-size:0.75rem;opacity:0.6;margin-top:0.25rem;}"
};
function ExampleStarsField($$anchor, $$props) {
  if (new.target)
    return createClassComponent({ component: ExampleStarsField, ...$$anchor });
  push($$props, false);
  ...
  each(div_1, 5, () => (get(max), untrack(() => Array(get(max)))), index, ($$anchor2, _, i) => {
    ...
    let classes;
    template_effect(() => {
      classes = set_class(button, 1, "example-star svelte-1feughz", null, classes, { filled: get(star) <= get(rating) });
