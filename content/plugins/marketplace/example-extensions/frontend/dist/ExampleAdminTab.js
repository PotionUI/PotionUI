...
// marketplace/example-extensions/frontend/src/ExampleAdminTab.svelte
var root = from_html(`<div class="example-admin-tab svelte-14rvvti"><h2 class="svelte-14rvvti">Example Extension</h2> <p>This tab is contributed by the <code>example-extensions</code> plugin via the <code>admin.tabs</code> extension slot.</p></div>`);
var $$css = {
  hash: "svelte-14rvvti",
  code: ".example-admin-tab.svelte-14rvvti {padding:1.5rem;}h2.svelte-14rvvti {font-size:1.125rem;font-weight:600;margin-bottom:0.5rem;}"
};
function ExampleAdminTab($$anchor, $$props) {
  if (new.target)
    return createClassComponent({ component: ExampleAdminTab, ...$$anchor });
  push($$props, false);
