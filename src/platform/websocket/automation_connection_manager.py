...
(`schedule_send`) as `NotificationConnectionManager` so the engine's
...
class AutomationConnectionManager(LoopDispatchMixin):
...
# Global instance
automation_connection_manager = AutomationConnectionManager()
