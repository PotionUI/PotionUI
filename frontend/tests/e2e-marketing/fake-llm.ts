// Duplicated verbatim from frontend/tests/e2e/fake-llm.ts rather than
// imported across testDir boundaries - same reasoning as helpers.ts's OWNER
// constant (this config's testDir is this directory, not ../e2e).
