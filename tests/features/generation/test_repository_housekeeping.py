"""GenerationRepository.find_for_housekeeping: the criteria admin bulk
deletion filters on, AND-ed, across every user."""
...
class TestFindForHousekeeping(PersistenceTestBase):
    ...
    def test_matches_across_every_user_by_default(self):
        ...
        pairs = self.repo.find_for_housekeeping()
    ...
    def test_older_than_days_excludes_recent_rows(self):
        ...
        pairs = self.repo.find_for_housekeeping(older_than_days=30)
    ...
    def test_without_media_excludes_generations_with_files(self):
        ...
        pairs = self.repo.find_for_housekeeping(without_media=True)
    ...
    def test_statuses_filters_to_the_given_set(self):
        ...
        pairs = self.repo.find_for_housekeeping(statuses=["failed"])
    ...
    def test_keep_favorites_excludes_favorited_rows(self):
        ...
        pairs = self.repo.find_for_housekeeping(keep_favorites=True)
    ...
    def test_keep_favorites_false_includes_favorited_rows(self):
        ...
        pairs = self.repo.find_for_housekeeping(keep_favorites=False)
    ...
    def test_criteria_are_and_ed_together(self):
        ...
        pairs = self.repo.find_for_housekeeping(older_than_days=30, statuses=["failed"])
