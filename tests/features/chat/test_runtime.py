...
class TestChatRuntimeInit:
    """Tests for ChatRuntime initialization."""
...
class TestSendMessageBehaviorTrace:
    ...
    async def test_behavior_trace_persisted_in_assistant_metadata(self):
        ...
        assert trace["memory"]["by_scope_dropped"] == {"global": 0, "preset": 0, "model": 0, "mode": 0, "session": 0}
...
class TestInjectMemoryBlock:
    """Tests for ChatRuntime._inject_memory_block."""
    ...
    def test_group_overflow_appends_visible_line_and_reports_dropped_count(self):
        ...
        assert result["by_scope_dropped"] == {"global": 5, "preset": 0, "model": 0, "mode": 0, "session": 0}
    ...
    def test_group_under_cap_reports_no_drops(self):
        ...
        assert result["by_scope_dropped"] == {"global": 0, "preset": 0, "model": 0, "mode": 0, "session": 0}
