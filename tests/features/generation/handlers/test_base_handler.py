...
class TestResolveStorageDir:
    def test_falls_back_to_storage_with_no_settings_manager(self):
    ...
    def test_uses_the_configured_directory(self):
        ...
        handler = _ConcreteHandler("gen-id", settings_manager=settings)
    ...
    def test_warn_once_flag_is_shared_across_handler_types(self, caplog):
        ...
        image_handler = ImageGenerationOutputHandler("gen-id", settings_manager=settings)
        audio_handler = AudioGenerationOutputHandler("gen-id", settings_manager=settings)
