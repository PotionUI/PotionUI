# Architecture reconstructed from the state-dict layout of the Apache-2.0 checkpoint LBH-123-AI/Minimax_h3_latent_Upscaler (header: ai/minimax_h3/latent_upscaler_3d_bf16_header.json).
# Interface semantics observed from the MIT-licensed reference node repo LBH-123-AI/Comfyui_Minimax_h3_latent_Upscaler; no code copied.
