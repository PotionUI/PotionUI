...
def _avatars_directory(settings_manager: SettingsManager) -> Path:
...
def delete_avatar_file(settings_manager: SettingsManager, filename: str) -> None:
    ...
    avatars_dir = _avatars_directory(settings_manager)
...
def resolve_avatar_path(settings_manager: SettingsManager, filename: str) -> Path:
...
def upload_avatar(
    ...
    if not updated_user:
        delete_avatar_file(settings_manager, new_filename)
...
def delete_avatar(repository: UserRepository, settings_manager: SettingsManager, user_id: str) -> User:
    """
